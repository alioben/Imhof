...
public class OSMMapTest {
    ...
    public void relationsListNonModifiable() throws Exception{
        ...
        if (!IM_COL_RELATIONS) {
            ...
            OSMMap testMap2 = new OSMMap(new ArrayList<OSMWay>(), testRelationList);
            ...
            OSMMap testMap3 = new OSMMap(new ArrayList<OSMWay>(), testRelationList);
    ...
    public void testGetterWays() {
        OSMMap map = new OSMMap(new ArrayList<OSMWay>(),new ArrayList<OSMRelation>());
    ...
    public void testEqualsNotRedefined() {
        OSMMap map1 = new OSMMap(new ArrayList<OSMWay>(),new ArrayList<OSMRelation>());
        OSMMap map2 = new OSMMap(new ArrayList<OSMWay>(),new ArrayList<OSMRelation>());
