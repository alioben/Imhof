...
public class OSMMapReaderTest {
    ...
    public void joinedBuildings() {
        OSMMap testMapReadResult = null;
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/testJoinedBuildings.osm").getFile(), false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
    ...
    public void roads() {
        OSMMap testMapReadResult = null;
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/testRoads.osm").getFile(), false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
    ...
    public void multipolygons() {
        OSMMap testMapReadResult = null;
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/testMultipolygons.osm").getFile(), false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
    ...
    public void DataCorrupted() {
        OSMMap testMapReadResult = null;
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/testDataCorrupted.osm").getFile(), false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
    ...
    public void typeLessRelations() {
        ...
        final String attr = "";
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/testTypelessRelations.osm").getFile(), false);
        } catch (Exception e) {
    ...
    public void gzipIsRespected(){
        OSMMap testMapReadResult = null;
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/testGZip.osm.gz").getFile(), true);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
        assertEquals(5, testMapReadResult.ways().size());
    ...
    public void onlyDefinedAttsUsed(){
        OSMMap testMapReadResult = null;
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/testUndefinedAtts.osm").getFile(), false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
        assertEquals(4, testMapReadResult.ways().size());
    ...
    public void learningCenter() {
    	try {
			OSMMapReader.readOSMFile(getClass().getResource("/lc.osm.gz").getFile(), true);
		} catch (Exception e) {
		    fail("Unable to recognise the file and/or read it properly.");
		}
    }
    ...
    public void errorInFile() throws Exception{
        OSMMapReader.readOSMFile(getClass().getResource("/testSimpleBuildingError.osm").getFile(), false);
    }
