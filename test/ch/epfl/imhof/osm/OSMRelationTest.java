...
public class OSMRelationTest extends OSMEntityTest{
    ...
    public void constructorWithNodeWayRelation() {
        ...
        OSMRelation relation = new OSMRelation(67, new ArrayList<Member>(), EMPTY_ATTRIBUTES);
    ...
    public void builderBuiltStepByStep() {
        ...
        OSMRelation testRelation = new OSMRelation(5,  new ArrayList<Member>(), EMPTY_ATTRIBUTES);
