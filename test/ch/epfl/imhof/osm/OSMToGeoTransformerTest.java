...
public class OSMToGeoTransformerTest {
    ...
    public void simpleBuilding() {
        ...
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/testSimpleBuilding.osm").getFile(), false);
        } catch (Exception e) {
    ...
    public void closedWayWithoutAttributeIsFiltered() {
        OSMMap testMapReadResult = null;
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/testWaysNoAttribute.osm").getFile(), false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
        Map testMap = testTransformer.transform(testMapReadResult);
    ...
    public void closedWayWithAreaAttribute() {
        OSMMap testMapReadResult = null;
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/testWaysWithAreaAttribute.osm").getFile(), false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
        Map testMap = testTransformer.transform(testMapReadResult);
    ...
    public void closedWayWithAttributes() {
        OSMMap testMapReadResult = null;
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/testWaysWithAttributes.osm").getFile(), false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
        Map testMap = testTransformer.transform(testMapReadResult);
    ...
    public void severalWallsTwoHoles() {
        OSMMap testMapReadResult = null;
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/testSeveralWalls.osm").getFile(), false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
        Map testMap = testTransformer.transform(testMapReadResult);
    ...
    public void roadWhole() {
        OSMMap testMapReadResult = null;
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/testRoadWhole.osm").getFile(), false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
        Map testMap = testTransformer.transform(testMapReadResult);
    ...
    public void joinedBuildingsFromRelation() {
        OSMMap testMapReadResult = null;
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/testJoinedBuildingsFromRelation.osm").getFile(), false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
        Map testMap = testTransformer.transform(testMapReadResult);
    ...
    public void joinedBuildingsFromClosedWay() {
        OSMMap testMapReadResult = null;
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/testJoinedBuildingsFromClosedWay.osm").getFile(), false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
        Map testMap = testTransformer.transform(testMapReadResult);
    ...
    public void buildingOnALandUse() {
        OSMMap testMapReadResult = null;
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/testBuildingOnALandUse.osm").getFile(), false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
        Map testMap = testTransformer.transform(testMapReadResult);
    ...
    public void buildingOneInnerHole() {
        OSMMap testMapReadResult = null;
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/testBuildingOneInnerHole.osm").getFile(), false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
        Map testMap = testTransformer.transform(testMapReadResult);
    ...
    public void buildingMultipleHoles() {
        OSMMap testMapReadResult = null;
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/testBuildingMultipleHoles.osm").getFile(), false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
        Map testMap = testTransformer.transform(testMapReadResult);
    ...
    public void notMultipolygon() {
        OSMMap testMapReadResult = null;
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/testNotMultipolygon.osm").getFile(), false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
        Map testMap = testTransformer.transform(testMapReadResult);
    ...
    public void orphanInnerRing() {
        OSMMap testMapReadResult = null;
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/testOrphanInnerRing.osm").getFile(), false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
        Map testMap = testTransformer.transform(testMapReadResult);
    ...
    public void tooManyNeighbors() {
        OSMMap testMapReadResult = null;
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/testTooManyNeighbors.osm").getFile(), false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
        Map testMap = testTransformer.transform(testMapReadResult);
    ...
    public void roadCorrupted() {
        OSMMap testMapReadResult = null;
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/testRoadCorrupted.osm").getFile(), false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
        Map testMap = testTransformer.transform(testMapReadResult);
    ...
    public void joinedBuildingsTaggedRelation() {
        OSMMap testMapReadResult = null;
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/testJoinedBuildingsTaggedRelation.osm").getFile(), false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
        Map testMap = testTransformer.transform(testMapReadResult);
    ...
    public void BuildingInsideBuilding() {
        OSMMap testMapReadResult = null;
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/testBuildingInsideBuilding.osm").getFile(), false);
        } catch (Exception e) {
    ...
    public void MultipleBuildingsInOneRelation() {
        OSMMap testMapReadResult = null;
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/testMultipleBuildingsInOneRelation.osm").getFile(), false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
        Map testMap = testTransformer.transform(testMapReadResult);
    ...
    public void PolygonRelationsToKeep() {
        OSMMap testMapReadResult = null;
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/testPolygonRelationsToKeep.osm").getFile(), false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
        Map testMap = testTransformer.transform(testMapReadResult);
    ...
    public void PolylineKeysToKeep() {
        OSMMap testMapReadResult = null;
        try {
            testMapReadResult = OSMMapReader.readOSMFile(getClass().getResource("/testPolylineKeysToKeep.osm").getFile(), false);
        } catch (Exception e) {
            fail("Unable to recognise the file and/or read it properly.");
        }
        Map testMap = testTransformer.transform(testMapReadResult);
